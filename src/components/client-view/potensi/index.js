...
export default function PotensiComponent() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        if (!response.ok) {
          throw new Error('Failed to fetch potensi.json');
        }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-3 text-gray-600 text-base font-medium">Memuat potensi...</p>
        </div>
      </div>
    );
  }
  ...
  if (!contentData || !contentData.potensi) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f8fafc', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex justify-between items-center text-xs text-gray-500">
                  <span>Tahun Mulai: {item.tahun_mulai}</span>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="text-center text-sm text-gray-500 font-medium">
          Menampilkan {startIndex + 1}-{Math.min(startIndex + itemsPerPage, filteredData.length)} dari {filteredData.length} potensi
