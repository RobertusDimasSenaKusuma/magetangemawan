  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <div className="bg-green1-500 backdrop-blur-sm rounded-xl shadow-lg border border-white-500 p-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-white-500 mb-1">Contact Messages</h1>
                <p className="text-white-500">Manage incoming contact messages from your portfolio</p>
              </div>
        ...
        {/* Contact Table */}
        <div className="bg-white/90 backdrop-blur-sm shadow-xl rounded-xl overflow-hidden border border-white/20">
          {data && data.length ? (
            <>
